...
Component.register('sw-cms-el-images-slider-text', {
    template,
    ...
    data() {
        return {
            ...
            imgText: [],
            defaultSlideContent: `
                        <h2>Genieße regionale Steaks mit gutem Gewissen</h2>
                        <div class="delight-component-text">
                        <p>ab 9,90 €</p>
                         <p><a target="_self" href="#" class="btn btn-primary">Jetzt bestellen</a><br></p>
                         </div>  
                    `.trim(),
            counter: 0
        };
