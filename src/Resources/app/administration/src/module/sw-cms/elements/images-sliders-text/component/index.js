...
Component.register('sw-cms-el-images-sliders-text', {
    template,
    ...
    data() {
        return {
            ...
            imgText: [],
            defaultSlideContent: `
                        <h2>Getreidefrei - Kartoffelfrei</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                        Aliquam autem culpa distinctio dolor eos ex id illo incidunt labore laudantium modi, odio officia officiis reprehenderit, sapiente. 
                        Atque culpa natus placeat voluptatum. Mollitia qui, voluptate. Aperiam ea officia rerum tempora voluptates. 
                        Dolor explicabo hic in ipsa labore numquam officia quasi sunt. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab, itaque.
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, sit!</p>
                    `.trim(),
            counter: 0
        };
    },
